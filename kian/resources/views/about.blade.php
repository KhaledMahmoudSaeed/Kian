            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-content">
                        <h4>@lang('messages.ABOUT_US')</h4>
                        <h2>@lang('messages.OUR_COMPANY')</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2>@lang('messages.OUR_BACKGROUND')</h2>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <div class="team-members">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2>@lang('messages.OUR_TEAM_MEMBERS')</h2>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <div class="happy-clients">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2>@lang('messages.HAPPY_PARTNERS')</h2>
                    </div>
                </div>
                <div class="col-md-12">
